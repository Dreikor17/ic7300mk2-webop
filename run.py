#!/usr/bin/env python3
"""Launch the IC-7300MK2 WebOp server. Usage: python run.py [--host H] [--port P]"""
import argparse
import os
import sys
import webbrowser
...
def main() -> None:
    ap = argparse.ArgumentParser(description="IC-7300MK2 WebOp server")
    ...
    if not args.no_browser and not args.reload:
        try:
            ...
            pass
    print(f"IC-7300MK2 WebOp -> {local}")
