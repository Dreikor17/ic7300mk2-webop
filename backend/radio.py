...
# IC-7300MK2 defaults; only used to draw the passband shade over the scope.
FILTER_BW = {
...
# A sensible default frequency per HF/6 m band button (Hz)
BAND_FREQ = {
    "160": 1_840_000, "80": 3_700_000, "60": 5_357_000, "40": 7_150_000,
    "30": 10_130_000, "20": 14_200_000, "17": 18_130_000, "15": 21_300_000,
...
class Radio:
    ...
    def connect(self, transport: Transport) -> None:
        ...
        # safety default: start at 0% TX power
